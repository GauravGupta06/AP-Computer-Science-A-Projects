...
public class Game extends Canvas implements Runnable, KeyListener, ActionListener
{
  ...
  private Track firstSectionTrack;
  private Track secondSectionTrack;
  private Track thirdSectionTrack;
  private Track fourthSectionTrack;
  private Track fifthSectionTrack;
  private Track sixthSectionTrack;
  private Track seventhSectionTrack;
  private int wait = 0;
  private int prices;
  ...
  public Game(int width, int height)
  {
    ...
    firstSectionTrack = new Track(0, 30, 200, 30);
    secondSectionTrack = new Track(200, 30, 30, 400);
    thirdSectionTrack = new Track(200, 400, 200, 30);
    fourthSectionTrack = new Track(400, 30, 30, 400);
    fifthSectionTrack = new Track(400, 30, 150, 30);
    sixthSectionTrack = new Track(550, 30, 30, 200);
